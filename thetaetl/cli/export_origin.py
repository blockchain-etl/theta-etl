...
from thetaetl.jobs.export_origin_job import ExportOriginJob
from thetaetl.jobs.exporters.origin_exporter import origin_marketplace_listing_item_exporter, origin_shop_product_item_exporter
from thetaetl.ipfs.origin import get_origin_ipfs_client
...
def export_origin(start_block, end_block, batch_size, marketplace_output, shop_output, max_workers, provider_uri):
    ...
    job = ExportOriginJob(
        ...
        web3=ThreadLocalProxy(lambda: get_provider_from_uri(provider_uri)),
