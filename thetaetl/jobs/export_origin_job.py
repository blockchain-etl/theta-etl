...
from thetaetl.mappers.origin_mapper import OriginMarketplaceListingMapper, OriginShopProductMapper
from thetaetl.service.origin_extractor import OriginEventExtractor
